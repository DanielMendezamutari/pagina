...
`},An={__name:"swiper",setup(i){return(e,t)=>{const s=on,r=ti,n=rn,d=Jr,p=Zr,a=Ur,f=Wr,l=Rr,o=Dr,c=Lr,m=Cr,w=yr,v=hr,h=mr,u=dr,b=lr,g=ar;return R(),ei(ii,null,{default:F(()=>[O(ee,null,{default:F(()=>[O(r,{title:"Basic",code:pn},{default:F(()=>[O(s)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Navigation",code:bn},{default:F(()=>[O(n)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Pagination",code:yn},{default:F(()=>[O(d)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Progress",code:Sn},{default:F(()=>[O(p)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Multiple Slides Per View",code:vn},{default:F(()=>[O(a)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Grid",code:gn},{default:F(()=>[O(f)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{variant:"text",title:"Centered Slides Option 1",code:dn},{default:F(()=>[O(l)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Centered Slides Option 2",code:cn},{default:F(()=>[O(o)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Fade",code:mn},{default:F(()=>[O(c)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Cube Effect",code:un},{default:F(()=>[O(m)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Coverflow Effect",code:fn},{default:F(()=>[O(w)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Autoplay",code:ln},{default:F(()=>[O(v)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Gallery",code:wn},{default:F(()=>[O(h)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Lazy Loading",code:hn},{default:F(()=>[O(u)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Responsive Breakpoints",code:xn},{default:F(()=>[O(b)]),_:1},8,["code"])]),_:1}),O(ee,null,{default:F(()=>[O(r,{title:"Virtual Slides",code:En},{default:F(()=>[O(g)]),_:1},8,["code"])]),_:1})]),_:1})}}};export{An as default};
