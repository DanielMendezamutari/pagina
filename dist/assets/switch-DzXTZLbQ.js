...
`},K=n("p",null,[i("A "),n("code",null,"v-switch"),i(" in its simplest form provides a toggle between 2 values.")],-1),Q=n("p",null,[i("To change the default "),n("code",null,"inset"),i(" switch, simply modify the inset prop to a "),n("code",null,"false"),i(" value.")],-1),X=n("p",null,[i("Switches can be colored by using any of the builtin colors and contextual names using the "),n("code",null,"color"),i(" prop.")],-1),Z=n("p",null,[i("Multiple "),n("code",null,"v-switch"),i("'s can share the same "),n("code",null,"v-model"),i(" by using an array.")],-1),ee=n("p",null,[i("Switch labels can be defined in "),n("code",null,"label"),i(" slot - that will allow to use HTML content.")],-1),te=n("p",null,[i(" Use "),n("code",null,"false-value"),i(" and "),n("code",null,"true-value"),i(" prop to sets value for truthy and falsy state ")],-1),le=n("p",null,[n("code",null,"v-switch"),i(" can have different states such as "),n("code",null,"default"),i(", "),n("code",null,"disabled"),i(", and "),n("code",null,"loading"),i(".")],-1),fe={__name:"switch",setup(w){return(e,o)=>{const c=k,l=$,s=B,u=P,_=z,g=A,V=J,x=C;return h(),v(D,null,{default:d(()=>[t(S,{cols:"12",md:"6"},{default:d(()=>[t(l,{title:"Basic",code:W},{default:d(()=>[K,t(c)]),_:1},8,["code"])]),_:1}),t(S,{cols:"12",md:"6"},{default:d(()=>[t(l,{title:"Inset",code:N},{default:d(()=>[Q,t(s)]),_:1},8,["code"])]),_:1}),t(S,{cols:"12",md:"6"},{default:d(()=>[t(l,{title:"Colors",code:H},{default:d(()=>[X,t(u)]),_:1},8,["code"])]),_:1}),t(S,{cols:"12",md:"6"},{default:d(()=>[t(l,{title:"Model as array",code:Y},{default:d(()=>[Z,t(_)]),_:1},8,["code"])]),_:1}),t(S,{cols:"12",md:"6"},{default:d(()=>[t(l,{title:"Label slot",code:R},{default:d(()=>[ee,t(g)]),_:1},8,["code"])]),_:1}),t(S,{cols:"12",md:"6"},{default:d(()=>[t(l,{title:"True and False Value",code:G},{default:d(()=>[te,t(V)]),_:1},8,["code"])]),_:1}),t(S,{cols:"12",md:"6"},{default:d(()=>[t(l,{title:"States",code:q},{default:d(()=>[le,t(x)]),_:1},8,["code"])]),_:1})]),_:1})}}};export{fe as default};
