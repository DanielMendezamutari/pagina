...
.mobile-landing {
  ...
  background:
    radial-gradient(80rem 18rem at 50% 18rem, #dceeff 0%, #dceeff 58%, transparent 59%),
    radial-gradient(70rem 16rem at 50% 38rem, #dceeff 0%, #dceeff 56%, transparent 57%),
...
.top-whatsapp {
  ...
  box-shadow: 0 10px 24px rgba(251, 140, 0, 0.3);
}
