...
const sectionLinks = [
  ...
  { label: 'Sectores', hash: '#sectors' },
  { label: 'Por qué elegir', hash: '#why-us' },
  { label: 'Testimonios', hash: '#testimonials' },
  { label: 'Contacto', hash: '#contact-us' },
]
      ...
      <div>
        <div class="d-flex flex-column gap-y-4 pa-4">
          <RouterLink
            ...
            :key="index"
            :to="{ name: 'front-pages-landing-page', hash: item.hash }"
            class="font-weight-medium"
            :class="[props.activeId === item.hash.replace('#', '') ? 'active-link' : 'text-high-emphasis']"
          >
            {{ item.label }}
          </RouterLink>
          <div
      ...
      <div class="d-flex align-center">
        ...
        >
          <RouterLink
            ...
            :class="[props.activeId === item.hash.replace('#', '') ? 'active-link' : '']"
          >
            {{ item.label }}
          </RouterLink>
