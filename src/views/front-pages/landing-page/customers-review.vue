...
const reviewData = [
  {
    desc: 'El sistema POS de Ribersoft ha transformado la forma en que manejamos nuestra farmacia.',
    img: logo1,
    rating: 5,
    name: 'Carmen López',
    position: 'Farmacia Salud',
  },
  {
    desc: 'Excelente software, fácil de usar y con todo lo que necesitábamos para nuestra tienda de ropa.',
    img: logo2,
    rating: 5,
    name: 'Carlos Martínez',
    position: 'Moda Estilo',
  },
  {
    desc: 'Muy completo, nos ayuda con las citas, pacientes y tratamientos en nuestra clínica dental.',
    img: logo3,
    rating: 5,
    name: 'Dra. Ana Torres',
    position: 'Clínica Dental Sonríe',
  },
]
</script>

<template>
  <div id="testimonials" class="customer-reviews">
    <!-- 👉 Headers  -->
    <div class="headers d-flex justify-center flex-column align-center mb-8">
      ...
      <div class="mb-2 text-center">
        ...
        >
          Lo que dicen
        </span> <span class="text-h5 d-inline-block">nuestros clientes</span>
      </div>

      <p class="text-body-1 font-weight-medium text-center">
        Opiniones reales de clientes satisfechos que usan Ribersoft POS.
      </p>
    </div>
